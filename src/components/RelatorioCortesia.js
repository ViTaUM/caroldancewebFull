...
export default function RelatorioCortesia() {
  ...
  const columns = React.useMemo(
    () => [
      {
        Header: "Nº",
        accessor: (row, i) => i + 1, // Acessor para criar o índice
        disableSortBy: true, // Desativa a ordenação para esta coluna
        disableFilters: true, // Desativa o filtro para esta coluna
      },
      {
        Header: "Data",
        accessor: "Data",
  ...
  const data = React.useMemo(
    () => seats.filter((seat) => parseInt(seat.Valor) === 0),
    [seats]
  );
